					...
					<div class="products">
						<div v-for="product in products" :key="product.id" class="products__item">
							<div class="products__hover">
								<a href="#"><img :src="product.image_url" alt="Product-1" class="products__img"></a>
								<a href="#" v-on:click.prevent="$emit('add-to-cart', product.id)" class="products__cart-btn"><img src="img/cart-white.png" alt="cart">Add to Cart</a>
							</div>
							<a href="#">
